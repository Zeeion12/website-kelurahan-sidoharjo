...
import { useAllPengajuan } from "@/lib/use-pengajuan-store";
...
export default function DashboardPage() {
    // TODO: ganti dengan query ke tabel `pengajuan` di Supabase (RLS khusus
    // petugas) setelah tabelnya dibuat. Untuk sementara membaca dari
    // localStorage yang sama dipakai formulir warga (lib/pengajuan-store.ts),
    // jadi hanya terlihat pengajuan yang dibuat di browser yang sama.
    const items = useAllPengajuan();
