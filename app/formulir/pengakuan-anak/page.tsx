...
export default function FormPengakuanAnakPage() {
      ...
      <header className="border-b border-[#1E2A4A]/10 bg-white/60">
        <div className="mx-auto max-w-3xl px-6 py-10 md:py-14">
          ...
          <h1 className={`${lora.className} mt-4 text-3xl font-semibold leading-tight md:text-4xl`}>
            Formulir Pencatatan Pengakuan Anak
          </h1>
          <p className="mt-3 max-w-2xl text-sm text-[#1E2A4A]/70 md:text-base">
            Lengkapi data pelapor, data akta kelahiran anak, data orang tua
            kandung, data penetapan pengadilan (bila ada), serta data saksi
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <Section title="Data Akta Kelahiran Anak">
            ...
            <Field
              ...
              hint="Bila orang tua telah menikah secara agama"
            >
              <input
                type="date"
                className={inputClass}
          ...
          <Section
            ...
            hint="Isi bila pengakuan anak melalui penetapan pengadilan"
          >
